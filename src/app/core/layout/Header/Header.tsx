        ...
        <div className="flex items-center gap-2 lg:gap-6 flex-1 lg:px-4">
          ...
          <div className="flex items-center gap-3 flex-1 max-w-[300px]">
            <div className="w-full">
              <Progress value={(stats.exp / stats.maxExp) * 100} />
            </div>
            <span className="text-sm font-medium text-zinc-400 flex items-center">
              {stats.exp.toLocaleString()}
              <span className="mx-1 text-zinc-600 inline-block align-middle">
                /
              </span>
              ...
              <span
                role="img"
                aria-label="XP"
                className="text-zinc-400 ml-1 inline align-middle"
              >
                xp
              </span>
            </span>
          ...
          <div className="lg:hidden">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                <DropdownMenuItem>Objectifs</DropdownMenuItem>
                <DropdownMenuItem>Succès</DropdownMenuItem>
                <DropdownMenuItem>Classement</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
